...
MapPoint::MapPoint(int idx_, Vector3d point3D_, Mat desc_, int kf_obs_, Vector2d obs_, Vector3d dir_, double sigma2_) : idx(idx_), point3D(point3D_), inlier(true)
{
...
MapLine::MapLine(int idx_, Vector6d line3D_, Mat desc_, int kf_obs_, Vector3d obs_, Vector3d dir_, Vector4d pts_, double sigma2_) : idx(idx_), line3D(line3D_), inlier(true)
{
    desc_list.push_back(desc_);
    obs_list.push_back(obs_);
    kf_obs_list.push_back(kf_obs_);

...
PinholeStereoCamera::PinholeStereoCamera(const int &width_, const int &height_,
                                         ...
                                         const double &b_,
                                         const double &d0, const double &d1, const double &d2, const double &d3, const double &d4) : width(width_), height(height_), fx(fx_), fy(fy_), cx(cx_), cy(cy_), b(b_), dist(d0 != 0.0)
{
    d << d0, d1, d2, d3, d4;
...
PinholeStereoCamera::PinholeStereoCamera(const int &width_, const int &height_,
                                         ...
                                         const double &d0, const double &d1, const double &d2, const double &d3, const double &d4) : width(width_), height(height_), fx(fx_), fy(fy_), cx(cx_), cy(cy_), b(b_), dist(d0 != 0.0), Rl(Rl_), Rr(Rr_)
{
    d << d0, d1, d2, d3, d4;
    Kl = (Mat_<float>(3, 3) << fx, 0.0, cx, 0.0, fy, cy, 0.0, 0.0, 1.0);
    Dl = (Mat_<float>(1, 5) << d(0), d(1), d(2), d(3), d(4));
...
PinholeStereoCamera::PinholeStereoCamera(const int &width_, const int &height_,
                                         ...
                                         const bool &equi) : width(width_), height(height_), Kl(Kl_), Kr(Kr_), b(b_), R(R_), t(t_), Dl(Dl_), Dr(Dr_)
{
